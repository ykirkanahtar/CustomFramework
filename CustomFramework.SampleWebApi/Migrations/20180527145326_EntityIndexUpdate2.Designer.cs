...
namespace CustomFramework.SampleWebApi.Migrations
{
    ...
    [Migration("20180527145326_EntityIndexUpdate2")]
    partial class EntityIndexUpdate2
    {
            ...
            modelBuilder.Entity("CustomFramework.WebApiUtils.Authorization.Models.ClientApplication", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ClientApplicationCode = "web", ClientApplicationName = "web", ClientApplicationPassword = "pkCNun4gzEIMGy4zYCII0E15VWmJBGP7JInopN8KY04=", CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 956, DateTimeKind.Local), Status = 1 }
                    );
                });
            ...
            modelBuilder.Entity("CustomFramework.WebApiUtils.Authorization.Models.ClientApplicationUtil", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ClientApplicationId = 1, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 956, DateTimeKind.Local), SpecialValue = "JOBotHTSFtda3PEPids7AQ==", Status = 1 }
                    );
                });
            ...
            modelBuilder.Entity("CustomFramework.WebApiUtils.Authorization.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 959, DateTimeKind.Local), Description = "Administration Role", RoleName = "Administrator", Status = 1 },
                        new { Id = 2, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Description = "Default User Role", RoleName = "NormalUser", Status = 1 },
                        new { Id = 3, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Description = "User for data writer like stats", RoleName = "DataWriter", Status = 1 }
                    );
                });
            ...
            modelBuilder.Entity("CustomFramework.WebApiUtils.Authorization.Models.RoleEntityClaim", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Entity = "Claim", RoleId = 1, Status = 1 },
                        new { Id = 2, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Entity = "ClientApplicationUtil", RoleId = 1, Status = 1 },
                        new { Id = 3, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Entity = "ClientApplication", RoleId = 1, Status = 1 },
                        new { Id = 4, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Entity = "UserClaim", RoleId = 1, Status = 1 },
                        new { Id = 5, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Entity = "UserEntityClaim", RoleId = 1, Status = 1 },
                        new { Id = 6, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Entity = "UserRole", RoleId = 1, Status = 1 },
                        new { Id = 7, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Entity = "UserUtil", RoleId = 1, Status = 1 },
                        new { Id = 8, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Entity = "User", RoleId = 1, Status = 1 },
                        new { Id = 9, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Entity = "RoleClaim", RoleId = 1, Status = 1 },
                        new { Id = 10, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Entity = "RoleEntityClaim", RoleId = 1, Status = 1 },
                        new { Id = 11, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Entity = "Role", RoleId = 1, Status = 1 },
                        new { Id = 12, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Entity = "Student", RoleId = 1, Status = 1 },
                        new { Id = 13, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Entity = "Course", RoleId = 1, Status = 1 },
                        new { Id = 14, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Entity = "Teacher", RoleId = 1, Status = 1 },
                        new { Id = 15, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 960, DateTimeKind.Local), Entity = "StudentCourse", RoleId = 1, Status = 1 }
                    );
                });
            ...
            modelBuilder.Entity("CustomFramework.WebApiUtils.Authorization.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AccessFailedCount = 0, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 958, DateTimeKind.Local), Email = "admin@admin.org", EmailConfirmCode = "9988", EmailConfirmed = false, Lockout = false, Password = "ex5M2IZNuDANAqb6MM/dFlHowZVJdfnRVkI22hTYHsI=", Status = 1, UserName = "admin" }
                    );
                });
            ...
            modelBuilder.Entity("CustomFramework.WebApiUtils.Authorization.Models.UserUtil", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreateDateTime = new DateTime(2018, 5, 27, 17, 53, 25, 958, DateTimeKind.Local), SpecialValue = "sXFs8XtiO3z9HG/A6ASCOg==", Status = 1, UserId = 1 }
                    );
                });
