...
namespace CustomFramework.SampleWebApi.Migrations
{
    ...
    [Migration("20180620133901_NewInit")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomFramework.SampleWebApi.Models.School", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.HasIndex("Name")
                        .IsUnique()
                        .HasName("ix_schools_name");

                    b.HasIndex("Status")
                        .HasName("ix_schools_status");
            ...
            modelBuilder.Entity("CustomFramework.WebApiUtils.Authorization.Models.ClientApplication", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ClientApplicationCode = "web", ClientApplicationName = "web", ClientApplicationPassword = "aYVLzJW/AQOeN+JlR37GO9s7NII3/pDAuAZqIFdg7NQ=", CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 683, DateTimeKind.Local), Status = 1 }
                    );
                });
            ...
            modelBuilder.Entity("CustomFramework.WebApiUtils.Authorization.Models.ClientApplicationUtil", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ClientApplicationId = 1, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 684, DateTimeKind.Local), SpecialValue = "eTD02xSb6n2qVCwwbVzGEg==", Status = 1 }
                    );
                });
            ...
            modelBuilder.Entity("CustomFramework.WebApiUtils.Authorization.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Description = "Administration Role", RoleName = "Administrator", Status = 1 },
                        new { Id = 2, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Description = "Default User Role", RoleName = "NormalUser", Status = 1 },
                        new { Id = 3, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Description = "User for data writer like stats", RoleName = "DataWriter", Status = 1 }
                    );
                });
            ...
            modelBuilder.Entity("CustomFramework.WebApiUtils.Authorization.Models.RoleEntityClaim", b =>
                {
                    ...
                    b.HasIndex("RoleId", "Entity", "CanCreate")
                        .HasName("ix_role_entity_claims_role_id_entity_can_create");

                    b.HasIndex("RoleId", "Entity", "CanDelete")
                        .HasName("ix_role_entity_claims_role_id_entity_can_delete");

                    b.HasIndex("RoleId", "Entity", "CanSelect")
                        .HasName("ix_role_entity_claims_role_id_entity_can_select");

                    b.HasIndex("RoleId", "Entity", "CanUpdate")
                        .HasName("ix_role_entity_claims_role_id_entity_can_update");

                    b.ToTable("role_entity_claims");

                    b.HasData(
                        new { Id = 1, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Entity = "Claim", RoleId = 1, Status = 1 },
                        new { Id = 2, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Entity = "ClientApplicationUtil", RoleId = 1, Status = 1 },
                        new { Id = 3, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Entity = "ClientApplication", RoleId = 1, Status = 1 },
                        new { Id = 4, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Entity = "UserClaim", RoleId = 1, Status = 1 },
                        new { Id = 5, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Entity = "UserEntityClaim", RoleId = 1, Status = 1 },
                        new { Id = 6, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Entity = "UserRole", RoleId = 1, Status = 1 },
                        new { Id = 7, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Entity = "UserUtil", RoleId = 1, Status = 1 },
                        new { Id = 8, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Entity = "User", RoleId = 1, Status = 1 },
                        new { Id = 9, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Entity = "RoleClaim", RoleId = 1, Status = 1 },
                        new { Id = 10, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Entity = "RoleEntityClaim", RoleId = 1, Status = 1 },
                        new { Id = 11, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Entity = "Role", RoleId = 1, Status = 1 },
                        new { Id = 12, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Entity = "Student", RoleId = 1, Status = 1 },
                        new { Id = 13, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Entity = "Course", RoleId = 1, Status = 1 },
                        new { Id = 14, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Entity = "Teacher", RoleId = 1, Status = 1 },
                        new { Id = 15, CanCreate = true, CanDelete = true, CanSelect = true, CanUpdate = true, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 686, DateTimeKind.Local), Entity = "StudentCourse", RoleId = 1, Status = 1 }
                    );
                });
            ...
            modelBuilder.Entity("CustomFramework.WebApiUtils.Authorization.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AccessFailedCount = 0, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 685, DateTimeKind.Local), Email = "admin@admin.org", EmailConfirmCode = "9988", EmailConfirmed = false, Lockout = false, Password = "SDbIJyeRC+4u9NZZ60b+rXIFmBK1+0qFgAMQcuoGJVs=", Status = 1, UserName = "admin" }
                    );
                });
            ...
            modelBuilder.Entity("CustomFramework.WebApiUtils.Authorization.Models.UserEntityClaim", b =>
                {
                    ...
                    b.HasIndex("UserId", "Entity", "CanCreate")
                        .HasName("ix_user_entity_claims_user_id_entity_can_create");

                    b.HasIndex("UserId", "Entity", "CanDelete")
                        .HasName("ix_user_entity_claims_user_id_entity_can_delete");

                    b.HasIndex("UserId", "Entity", "CanSelect")
                        .HasName("ix_user_entity_claims_user_id_entity_can_select");

                    b.HasIndex("UserId", "Entity", "CanUpdate")
                        .HasName("ix_user_entity_claims_user_id_entity_can_update");
            ...
            modelBuilder.Entity("CustomFramework.WebApiUtils.Authorization.Models.UserUtil", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreateDateTime = new DateTime(2018, 6, 20, 16, 39, 0, 685, DateTimeKind.Local), SpecialValue = "hLrfvSHeXmIclhKeRYWu/g==", Status = 1, UserId = 1 }
                    );
                });
