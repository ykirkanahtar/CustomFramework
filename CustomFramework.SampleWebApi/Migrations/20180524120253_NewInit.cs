        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    email_confirm_code = table.Column<string>(maxLength: 6, nullable: false, defaultValue: "552443"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "web", "web", "J/UuRlbexS494KYH+mzeNr6bS9w72KCfYPbxPG+XWu0=", new DateTime(2018, 5, 24, 15, 2, 52, 580, DateTimeKind.Local), null, 1, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "Administration Role", "Administrator", 1, null },
                    { 2, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "Default User Role", "NormalUser", 1, null },
                    { 3, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "User for data writer like stats", "DataWriter", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, new DateTime(2018, 5, 24, 15, 2, 52, 583, DateTimeKind.Local), null, "admin@admin.org", "9988", false, false, null, "qDfGZYPauNZ6xPA2lGtNEefnyJAgWZtw89z8k5R0GM4=", 1, null, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2018, 5, 24, 15, 2, 52, 581, DateTimeKind.Local), null, "EAMW+hGDG9kUeO7l9ryyqQ==", 1, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 14, true, true, true, true, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "Teacher", 1, 1, null },
                    { 13, true, true, true, true, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "Course", 1, 1, null },
                    { 12, true, true, true, true, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "Student", 1, 1, null },
                    { 11, true, true, true, true, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "Role", 1, 1, null },
                    { 10, true, true, true, true, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "RoleEntityClaim", 1, 1, null },
                    { 9, true, true, true, true, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "RoleClaim", 1, 1, null },
                    { 15, true, true, true, true, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "StudentCourse", 1, 1, null },
                    { 8, true, true, true, true, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "User", 1, 1, null },
                    { 6, true, true, true, true, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "UserRole", 1, 1, null },
                    { 5, true, true, true, true, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "UserEntityClaim", 1, 1, null },
                    { 4, true, true, true, true, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "UserClaim", 1, 1, null },
                    { 3, true, true, true, true, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "ClientApplication", 1, 1, null },
                    { 2, true, true, true, true, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "ClientApplicationUtil", 1, 1, null },
                    { 1, true, true, true, true, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "Claim", 1, 1, null },
                    { 7, true, true, true, true, new DateTime(2018, 5, 24, 15, 2, 52, 585, DateTimeKind.Local), null, "UserUtil", 1, 1, null }
                });

            migrationBuilder.InsertData(
                table: "user_utils",
                columns: new[] { "id", "create_date_time", "delete_date_time", "special_value", "status", "update_date_time", "user_id" },
                values: new object[] { 1, new DateTime(2018, 5, 24, 15, 2, 52, 583, DateTimeKind.Local), null, "CEeNvaC3EvWhST6kaUeKKQ==", 1, null, 1 });
