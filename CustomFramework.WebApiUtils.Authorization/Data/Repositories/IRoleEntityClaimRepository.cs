...
namespace CustomFramework.WebApiUtils.Authorization.Data.Repositories
{
    ...
    {
        Task<RoleEntityClaim> GetByRoleIdAndEntityAsync(int roleId, string entity);
        Task<ICustomList<RoleEntityClaim>> RolesAreAuthorizedForEntityClaimAsync(IEnumerable<Role> roles, string entity, Crud crud);
